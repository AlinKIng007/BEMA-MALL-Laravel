...
<div class="container">
    ...
    <form id="signupForm" method="POST" action="<?php echo e(route('signup')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="page">
            ...
            <div class="field">
                ...
                <input type="tel" name="phone_number" value="<?php echo e(old('phone_number')); ?>" required>
            </div>
        ...
        <div class="page">
            ...
            <div class="field">
                ...
                <input type="text" name="zip_code" value="<?php echo e(old('zip_code')); ?>" required>
            </div>
            <div class="field btns">
    ...
    <div class="signup-link text-center mt-3">
        Already a Member? <a href="<?php echo e(route('login')); ?>" class="text-orange-600 font-bold">Login now</a>
    </div>
</div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AA7\Desktop\programming\Laravel\mall---v6\mall\resources\views/auth/signup.blade.php ENDPATH**/ ?>