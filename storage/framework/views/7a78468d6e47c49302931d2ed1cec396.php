            ...
            <div class="cart-item flex items-center justify-between p-4 border-b">
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-2">
                        <button onclick="updateQuantity(<?php echo e($result->id); ?>, -1,<?php echo e($result->p_amount); ?>)" class="quantity-btn w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center">
...
<?php endif; ?>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <span id="subtotal" class="text-xl font-bold text-orange-600">$0.00</span>
            </div>
            <div class="flex justify-between items-center mb-4">
                <span class="text-lg font-semibold text-gray-700">Shipping:</span>
                <span class="text-xl font-bold text-orange-600">$0.00</span>
            </div>
...
<?php /**PATH C:\Users\AA7\Desktop\programming\Laravel\mall---v4\mall\resources\views/cart.blade.php ENDPATH**/ ?>