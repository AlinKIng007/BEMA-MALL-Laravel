<?php
    $mall_name = session('mall_name') ?? 'Select a Mall';
?>
...
<header class="bg-white shadow-md fixed w-full z-50">
            ...
            <div class="flex items-center space-x-4">
                <div class="relative group">
                    <button id="mall-selector" type="button" class="flex items-center space-x-2 text-2xl font-bold gradient-text">
                        <span id="selected-mall"><?php echo e($mall_name); ?></span>
    ...
    <form method="POST" action="<?php echo e(route('set.mall')); ?>">
        ...
        <button type="submit" class="w-full text-left flex items-center px-4 py-3 hover:bg-orange-50 transition-colors">
            <img src="https://via.placeholder.com/30" alt="<?php echo e($mall->mall_name); ?>" class="w-8 h-8 rounded-full object-cover mr-3">
            <div>
...
<?php /**PATH C:\Users\AA7\Desktop\programming\Laravel\mall\resources\views/partials/navbar.blade.php ENDPATH**/ ?>