        ...
        <form id="signupForm" method="POST" action="<?php echo e(route('signup')); ?>">
            ...
            <div class="page">
                ...
                <div class="field">
                    ...
                    <select name="country" required>
                        ...
                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($country->id); ?>" <?php echo e(old('country') == $country->id ? 'selected' : ''); ?>>
                ...
                <div class="field">
                    ...
                    <input type="text" name="zip" value="<?php echo e(old('zip')); ?>" required>
                </div>
                <div class="field btns">
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bahaa\OneDrive\Desktop\laravel\mall\resources\views/auth/signup.blade.php ENDPATH**/ ?>