...
<form id="addToCartForm" action="/cartadd" method="POST">
            ...
            <div class="quantity-control">
                ...
                <div class="quantity-wrapper">
                    ...
                    <input type="number" id="quantity" name="amount" value="1" min="1" max="<?php echo e($products->amount); ?>">
            ...
            <div class="action-buttons">
                <button class="btn wishlist-btn" id="wishlist-button" onclick="addToWishlist()">
                    ...
                    <input type="text" id="user_id" value="<?php echo e(Auth::user()->id); ?>" name="user_id" style="display: none">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AA7\Desktop\programming\Laravel\mall---v6\mall\resources\views/product.blade.php ENDPATH**/ ?>